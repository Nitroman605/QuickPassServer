...
public class FileServlet extends HttpServlet {
            ...
            throws IOException
    {
        ...
        String newID = sb.deleteCharAt(0).toString();
        System.out.println("the Id is = "+newID);
        String ip = request.getHeader("X-FORWARDED-FOR");
        String requestedFile = Functions.verifySession(ip, newID);
        System.out.println("The file path "+requestedFile);
